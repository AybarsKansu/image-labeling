...
//         const hasPrompt = textPrompt && textPrompt.trim().length > 0;
//         const isWorldModel = selectedModel.toLowerCase().includes('world');

//         // Eğer prompt var ama seçili model YOLO-World değilse kullanıcıyı uyaralım
//         if (hasPrompt && !isWorldModel) {
//             const confirmSwitch = window.confirm(
//                 `You entered a text prompt ("${textPrompt}"), but the selected model (${selectedModel}) does not support text-based detection. \n\nDo you want to continue with Standard Detection (ignoring the prompt) or cancel to change your model?`
//             );
