...
function App() {
  ...
  const handleSaveAll = useCallback(async () => {
    try {
      if (!fileSystem.files || fileSystem.files.length === 0) {
        // alert("No files to save."); // Optional: don't alert, just return or show message
  ...
  // ============================================
  // LABEL IMPORT HANDLER (New)
  // ============================================


  // ============================================
  // PROJECT EXPORT HANDLER (New)
  // ============================================
  ...
  // ============================================
  // SINGLE IMAGE EXPORT HANDLER (New)
  // ============================================
  const handleExportCurrent = useCallback((format) => {
    try {
      ...
      // Use custom filename based on image name
